...
public class SwaggerConfig {
    ...
    public ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Bookpago REST API Documentation")
                .description("bookpago rest api doc")
                .version(".")
                .build();
    }
    ...
    public Docket api() {
        return new Docket(DocumentationType.OAS_30)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.kream.chouxkream")) // Controller가 들어있는 패키지. 이 경로의 하위에 있는 api만 표시됨.
